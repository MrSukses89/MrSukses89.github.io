...
// Load gambar latar belakang (opsional)
...
function updateSnake() {
    ...
    if (head.x === food.x && head.y === food.y) {
        ...
        if (score >= lastRockScore + 100) {
            rockCount++;
            lastRockScore = Math.floor(score / 100) * 100;
...
function resetGame() {
    ...
    scoreTextElement.textContent = score; // Reset skor di HTML
}
